...
Here, $J$ is the energy flux from e-bath to ph-bath. $T_e$ and $T_{ph}$ are the temperature of the e-bath and ph-bath, respectively. The trace Tr is over system DOF, with $\mathcal{A}_{ph}=i D^r(\Pi^r-\Pi^a)D^a$ the spectral function of the system due to coupling to the ph-bath. The summation over $\alpha\beta$ includes contributions from all the four types of EHPs. Each of them contributes to one transport channel. 
...
\begin{figure}[h]
	...
	\includegraphics[width=0.75\textwidth,angle=0]{figures/fig_5.pdf}	
