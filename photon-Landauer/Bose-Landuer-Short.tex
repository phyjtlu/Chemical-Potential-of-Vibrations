...
Our general framework opens the way of nonequilibrium reservoir engineering for efficient energy control between different quasi-particles in the nanoscale.
...
\begin{figure}[h]
	...
	\caption{Energy current from the e-bath to the bosonic mode as a function of applied bias, corresponding to the situation in Fig.~\ref{fig:resonant} (b). Negative $J$ means cooling of the bosonic mode.  \revision{BZH: Mark the cooling region (bottom-left rectangular region) with transparent gray background.}}
	\label{fig:cooling}
\end{figure}
