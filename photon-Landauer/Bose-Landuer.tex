...
\end{align}
This is a generalized detailed balance equation for the emission and absorption of the bosonic quanta. For e-bath in equilibrium ($\mu_L=\mu_R$), we recover the equilibrium detailed balance relation.
...
{\bf Heat rectification in hybrid electron-boson system--}
